      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="宽度">
            <el-input-number v-model="activeElement.width" controls-position="right" :min="1" class="min-input"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="高度">
            <el-input-number v-model="activeElement.height" controls-position="right" :min="1" class="min-input"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="横坐标">
            <el-input-number v-model="activeElement.left" controls-position="right" :min="0" class="min-input"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="纵坐标">
            <el-input-number v-model="activeElement.top" controls-position="right" :min="0" class="min-input"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="字体颜色">
            <el-color-picker :disabled="activeElement.style.FontColor===undefined" v-model="activeElement.style.FontColor"></el-color-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="边框颜色">
            <el-color-picker :disabled="activeElement.style.BorderColor===undefined" v-model="activeElement.style.BorderColor"></el-color-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
